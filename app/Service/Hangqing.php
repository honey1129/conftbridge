...
define('ACCESS_KEY','5e0da3b9-d7bd07ab-xa2b53ggfc-21821'); // your ACCESS_KEY
define('SECRET_KEY', '1c614445-3e529b5a-3f219fd8-e793f'); // your SECRET_KEY
class Hangqing {
...
//	private $url = 'https://api.hadax.com';
	...
	*/
	...
	function get_history_kline($symbol = '', $period='',$size=0) {
		...
		return json_decode($this->curl($url),5);
	}
	// 获取聚合行情(Ticker)
