...
namespace Encore\Admin\Facades {
    ...
    /**
     * @see \Encore\Admin\Traits\HasAssets::css
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View css(null $css = null)
     * @see \Encore\Admin\Admin::getModel
     * @method static mixed getModel($model)
     * @see \Encore\Admin\Admin::guard
     * @method static \Illuminate\Contracts\Auth\Guard|\Illuminate\Contracts\Auth\StatefulGuard guard()
     * @see \Encore\Admin\Admin::show
     * @method static \Encore\Admin\Show show($model, $callable = null)
     * @see \Encore\Admin\Traits\HasAssets::js
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View js(null $js = null)
     * @see \Encore\Admin\Admin::registerAuthRoutes
     * @method static void registerAuthRoutes()
     * @see \Encore\Admin\Admin::bootstrap
     * @method static void bootstrap()
     * @see \Encore\Admin\Admin::menuLinks
     * @method static array menuLinks(array $menu = [])
     * @see \Encore\Admin\Admin::title
     * @method static string title()
     * @see \Encore\Admin\Admin::content
     * @method static \Encore\Admin\Layout\Content content(\Closure $callable = null)
     * @see \Encore\Admin\Traits\HasAssets::jQuery
     * @method static string jQuery()
     * @see \Encore\Admin\Traits\HasAssets::headerJs
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View headerJs(null $js = null)
     * @see \Encore\Admin\Admin::routes
     * @method static void routes()
     * @see \Encore\Admin\Admin::navbar
     * @method static \Encore\Admin\Widgets\Navbar navbar(\Closure $builder = null)
     * @see \Encore\Admin\Admin::getNavbar
     * @method static \Encore\Admin\Widgets\Navbar getNavbar()
     * @see \Encore\Admin\Admin::booted
     * @method static void booted(callable $callback)
     * @see \Encore\Admin\Traits\HasAssets::html
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View html(string $html = '')
     * @see \Encore\Admin\Traits\HasAssets::baseJs
     * @method static array|null baseJs(null $js = null)
     * @see \Encore\Admin\Admin::favicon
     * @method static string|void favicon(null|string $favicon = null)
     * @see \Encore\Admin\Admin::tree
     * @method static \Encore\Admin\Tree tree($model, \Closure $callable = null)
     * @see \Encore\Admin\Admin::menu
     * @method static array menu()
     * @see \Encore\Admin\Traits\HasAssets::script
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View script(string $script = '', bool $deferred = false)
     * @see \Encore\Admin\Admin::booting
     * @method static void booting(callable $callback)
     * @see \Encore\Admin\Admin::disablePjax
     * @method static void disablePjax()
     * @see \Encore\Admin\Admin::extend
     * @method static void extend(string $name, string $class)
     * @see \Encore\Admin\Admin::getLongVersion
     * @method static string getLongVersion()
     * @see \Encore\Admin\Admin::setTitle
     * @method static void setTitle(string $title)
     * @see \Encore\Admin\Admin::form
     * @method static \Encore\Admin\Form form($model, \Closure $callable)
     * @see \Encore\Admin\Admin::grid
     * @method static \Encore\Admin\Grid grid($model, \Closure $callable)
     * @see \Encore\Admin\Traits\HasAssets::style
     * @method static array|\Illuminate\Contracts\View\Factory|\Illuminate\View\View style(string $style = '')
     * @see \Encore\Admin\Admin::user
     * @method static \Illuminate\Contracts\Auth\Authenticatable|null user()
     * @see \Encore\Admin\Traits\HasAssets::baseCss
     * @method static array|null baseCss(null $css = null)
     */
    class Admin {}
}
...
namespace Illuminate\Support\Facades {
     ...
     * @see \Predis\ClientInterface::strlen
     * @method static int strlen($key)
     * @see \Predis\Client::getOptions
     * @method static \Predis\Configuration\Options|\Predis\Configuration\OptionsInterface getOptions()
     * @see \Predis\ClientInterface::hdel
     * @method static int hdel($key, array $fields)
     * @see \Predis\ClientInterface::geohash
     * @method static array geohash($key, array $members)
     * @see \Predis\ClientInterface::hincrbyfloat
     * @method static string hincrbyfloat($key, $field, $increment)
     * @see \Predis\ClientInterface::lrem
     * @method static int lrem($key, $count, $value)
     * @see \Predis\ClientInterface::hlen
     * @method static int hlen($key)
     * @see \Predis\ClientInterface::decr
     * @method static int decr($key)
     * @see \Predis\ClientInterface::info
     * @method static array info($section = null)
     * @see \Predis\ClientInterface::ltrim
     * @method static mixed ltrim($key, $start, $stop)
     * @see \Predis\ClientInterface::slaveof
     * @method static mixed slaveof($host, $port)
     * @see \Predis\ClientInterface::rpop
     * @method static string rpop($key)
     * @see \Illuminate\Redis\RedisManager::disableEvents
     * @method static void disableEvents()
     * @see \Predis\ClientInterface::pfadd
     * @method static int pfadd($key, array $elements)
     * @see \Predis\ClientInterface::eval
     * @method static mixed eval($script, $numkeys, $keyOrArg1 = null, $keyOrArgN = null)
     * @see \Predis\Client::executeCommand
     * @method static mixed|\Predis\Response\ErrorInterface|\Predis\Response\ResponseInterface executeCommand(\Predis\Command\CommandInterface $command)
     * @see \Predis\ClientInterface::linsert
     * @method static int linsert($key, $whence, $pivot, $value)
     * @see \Predis\Client::executeRaw
     * @method static mixed|string executeRaw(array $arguments, bool $error = null)
     * @see \Predis\ClientInterface::pfcount
     * @method static int pfcount(array $keys)
     * @see \Predis\ClientInterface::exec
     * @method static array exec()
     * @see \Predis\ClientInterface::incrby
     * @method static int incrby($key, $increment)
     * @see \Predis\ClientInterface::getset
     * @method static string getset($key, $value)
     * @see \Predis\ClientInterface::spop
     * @method static string spop($key, $count = null)
     * @see \Predis\ClientInterface::hset
     * @method static int hset($key, $field, $value)
     * @see \Predis\ClientInterface::pexpireat
     * @method static int pexpireat($key, $timestamp)
     * @see \Predis\ClientInterface::hmset
     * @method static mixed hmset($key, array $dictionary)
     * @see \Predis\ClientInterface::zrevrangebyscore
     ...
     * @see \Predis\ClientInterface::decrby
     * @method static int decrby($key, $decrement)
     * @see \Predis\ClientInterface::setbit
     * @method static int setbit($key, $offset, $value)
     * @see \Illuminate\Redis\Connections\Connection::getName
     * @method static null|string getName()
     * @see \Predis\Client::pipeline
     * @method static array|\Predis\Pipeline\Pipeline pipeline()
     * @see \Predis\ClientInterface::srem
     * @method static int srem($key, $member)
     * @see \Predis\ClientInterface::getrange
     * @method static string getrange($key, $start, $end)
     * @see \Predis\ClientInterface::rename
     * @method static mixed rename($key, $target)
     * @see \Predis\ClientInterface::zrevrank
     * @method static int zrevrank($key, $member)
     * @see \Predis\ClientInterface::exists
     * @method static int exists($key)
     * @see \Predis\ClientInterface::setrange
     * @method static int setrange($key, $offset, $value)
     * @see \Predis\ClientInterface::sadd
     * @method static int sadd($key, array $members)
     * @see \Predis\ClientInterface::zrevrangebylex
     * @method static array zrevrangebylex($key, $start, $stop, array $options = null)
     * @see \Predis\ClientInterface::zrevrange
     * @method static array zrevrange($key, $start, $stop, array $options = null)
     * @see \Predis\Client::transaction
     * @method static array|\Predis\Transaction\MultiExec transaction()
     * @see \Predis\ClientInterface::sdiffstore
     * @method static int sdiffstore($destination, array $keys)
     * @see \Predis\ClientInterface::zincrby
     * @method static string zincrby($key, $increment, $member)
     * @see \Predis\ClientInterface::auth
     * @method static mixed auth($password)
     * @see \Predis\ClientInterface::rpushx
     * @method static int rpushx($key, $value)
     * @see \Predis\Client::getConnection
     * @method static \Predis\Connection\ConnectionInterface getConnection()
     * @see \Predis\ClientInterface::psetex
     ...
     * @method static \Predis\Command\CommandInterface createCommand($commandID, $arguments = array())
     * @see \Predis\ClientInterface::brpop
     * @method static array brpop(array $keys, $timeout)
     * @see \Illuminate\Redis\RedisManager::connections
     * @method static array connections()
     * @see \Predis\ClientInterface::pubsub
     * @method static mixed pubsub($subcommand, $argument)
     * @see \Predis\ClientInterface::lpush
     * @method static int lpush($key, array $values)
     * @see \Predis\ClientInterface::lindex
     * @method static string lindex($key, $index)
     * @see \Predis\ClientInterface::zrange
     * @method static array zrange($key, $start, $stop, array $options = null)
     * @see \Predis\ClientInterface::slowlog
     * @method static mixed slowlog($subcommand, $argument = null)
     * @see \Predis\ClientInterface::sort
     * @method static array sort($key, array $options = null)
     * @see \Predis\Client::getProfile
     * @method static mixed|\Predis\Profile\ProfileInterface getProfile()
     ...
     * @see \Predis\ClientInterface::ttl
     ...
     * @see \Predis\ClientInterface::smembers
     * @method static array smembers($key)
     * @see \Predis\ClientInterface::sscan
     * @method static array sscan($key, $cursor, array $options = null)
     * @see \Predis\ClientInterface::mget
...
namespace {
    ...
    class Google extends Earnp\GoogleAuthenticator\Facades\GoogleAuthenticator {}
